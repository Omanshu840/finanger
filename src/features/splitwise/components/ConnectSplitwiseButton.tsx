...
import { startSplitwiseAuth, disconnectSplitwise, getAuthStatus } from '@/features/splitwise/api/splitwiseAuth'
...
export default function ConnectSplitwiseButton() {
  ...
  const handleRefresh = async () => {
    ...
    try {
      ...
      setUser(userData)
      void queryClient.invalidateQueries({ queryKey: splitwiseQueryKeys.all })
