...
import type { SplitwiseGroup, SplitwiseFriend } from '@/features/splitwise/api/splitwiseApi'
...
export function SplitwiseExpenseSheet({
  ...
  const handleSuccess = () => {
    void queryClient.invalidateQueries({ queryKey: splitwiseQueryKeys.expenses() })
    setSelectedEntity(null)
    setOpen(false)
